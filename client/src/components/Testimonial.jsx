const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        ...
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Contello has made our content creation process effortless. The AI tools have helped us produce high-quality content faster than ever before. It completely revolutionized our content workflow.</p>
