  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            ...
            <p className='text-gray-500 max-w-lg mx-auto'>Empower your workflow with advanced AI tools engineered to generate, refine, and streamline content creation at scale.</p>
        </div>
